...
int main(int argc, char * argv[]) {
    ...
    //Add your implementation here
        ...
        unsigned int rs,rt,rd;//get the rs,rt,rd funct part
        uint8_t funct;
	...
	rd = rd >> 11;
        if (opcode == 0 && rd != 0){ //R-type
            ...
            else if (funct==0b001100){ //syscall
            ...
            else if (funct==0b001000){ //jr
                
                newPC = RegFile[rs];
                on_bit=4;
            }
        }
        else if (opcode==0x20000000 && rt != 0){ //addi
            int32_t imme = CurrentInstruction & 0x0000ffff;
            imme <<=16;
            imme >>=16;
            RegFile[rt] = RegFile[rs] + imme;
        }
        else if (opcode==0x24000000 && rt != 0){ //addiu
            int32_t imme = CurrentInstruction & 0x0000ffff;
            imme <<= 16;
            imme >>= 16;
            RegFile[rt] = RegFile[rs] + imme;
        }
        else if (opcode==0x30000000 && rt != 0){ //andi
            uint32_t imme = CurrentInstruction & 0x0000ffff;
            RegFile[rt] = RegFile[rs] & imme;
        }
        else if (opcode==0x38000000 && rt != 0){ //xori
            uint32_t imme = CurrentInstruction & 0x0000ffff;
            RegFile[rt] = RegFile[rs] ^ imme;
        }
        else if (opcode==0x34000000 && rt != 0){ //ori
            uint32_t imme = CurrentInstruction & 0x0000ffff;
            RegFile[rt] = RegFile[rs] | imme;
        }
        else if (opcode==0x28000000 && rt != 0){ //slti
            int32_t imme = CurrentInstruction & 0x0000ffff;
            if( RegFile[rs] < imme){
                RegFile[rt]=1;
            }
        ...
        else if (opcode==0x2c000000 && rt != 0){ //sltiu
            uint32_t imme = CurrentInstruction & 0x0000ffff;
        ...
        else if (opcode==0x3c000000 && rt != 0){ //LUI
                RegFile[rt] = (RegFile[rt] & 0x00000000) + ((CurrentInstruction & 0x0000ffff) << 16);
        }
        else if (opcode==0x80000000 && rt != 0){ //LB
                int32_t imme = CurrentInstruction & 0x0000ffff;
                imme <<=16;
                imme >>=16;
        ...
        else if (opcode==0x90000000 && rt != 0){ //LBU
                int32_t imme = CurrentInstruction & 0x0000ffff;
                imme <<=16;
                imme >>=16;
                uint32_t addr= RegFile[rs] + imme;
        ...
        else if (opcode==0x84000000 && rt != 0){ //LH
                int32_t imme = CurrentInstruction & 0x0000ffff;
                imme <<=16;
                imme >>=16;
                uint32_t addr= RegFile[rs] + imme;
        ...
        else if (opcode==0x94000000 && rt != 0){ //LHU
                int32_t imme = CurrentInstruction & 0x0000ffff;
                imme <<=16;
                imme >>=16;
                uint32_t addr= RegFile[rs] + imme;
        ...
        else if (opcode==0x8c000000 && rt != 0){ //LW
                int32_t imme = CurrentInstruction & 0x0000ffff;
                imme <<=16;
                imme >>=16;
                uint32_t addr= RegFile[rs] + imme;
        ...
        else if (opcode==0x88000000 && rt != 0){ //LWL
	...
	else if (opcode==0x98000000 && rt != 0){ //LWR
		int32_t imme = CurrentInstruction & 0x0000ffff;
		imme <<=16;
        	imme >>=16;
        	uint32_t loadAddr= RegFile[rs] + imme;
        ...
        else if (opcode==0x50000000){ //beql
            if (RegFile[rs]==RegFile[rt]){
            int32_t imme1 = CurrentInstruction & 0x0000ffff;
            imme1 <<=16;
            imme1 >>=14;
        ...
        else if (opcode==0x70000000){ //bgtz
            if (RegFile[rs] > 0){
                int32_t imme1 = CurrentInstruction & 0x0000ffff;
                imme1 <<=16;
                imme1 >>=14;
        ...
        else if (opcode==0x60000000){ //blez
            if (RegFile[rs] <= 0){
                int32_t imme1 = CurrentInstruction & 0x0000ffff;
                imme1 <<=16;
                imme1 >>=14;
        ...
        else if (opcode==0x58000000){ //blezl
            if (RegFile[rs]<=0){
            int32_t imme1 = CurrentInstruction & 0x0000ffff;
            imme1 <<=16;
            imme1 >>=14;
        ...
        else if (opcode==0x54000000){ //bnel
            if (RegFile[rs]!=RegFile[rt]){
            int32_t imme1 = CurrentInstruction & 0x0000ffff;
            imme1 <<=16;
            imme1 >>=14;
        ...
        else if (opcode==0x04000000){ //REGIMM=1
                if (rt==1) { //bgez
                    if (RegFile[rs]>=0){
                        int32_t imme1 = CurrentInstruction & 0x0000ffff;
                        imme1 <<=16;
