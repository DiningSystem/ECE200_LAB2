...
int main(int argc, char * argv[]) {
    ...
    //Add your implementation here
        ...
        else if (opcode==0x20000000){ //addi
            int32_t imme = CurrentInstruction & 0x0000ffff;
            imme <<=16;
            imme >>=16;
            RegFile[rt] = RegFile[rs] + imme;
        }
        else if (opcode==0x24000000){ //addiu
            int32_t imme = CurrentInstruction & 0x0000ffff;
            imme <<=16;
            imme >>=16;
            RegFile[rt] = RegFile[rs] + imme;
        }
        else if (opcode==0x30000000){ //andi
            uint32_t imme = CurrentInstruction & 0x0000ffff;
            RegFile[rt] = RegFile[rs] & imme;
        }
        else if (opcode==0x38000000){ //xori
            uint32_t imme = CurrentInstruction & 0x0000ffff;
            RegFile[rt] = RegFile[rs] ^ imme;
        }
        else if (opcode==0x34000000){ //ori
            uint32_t imme = CurrentInstruction & 0x0000ffff;
            RegFile[rt] = RegFile[rs] | imme;
        }
        else if (opcode==0x28000000){ //slti
            int32_t imme = CurrentInstruction & 0x0000ffff;
            if( RegFile[rs] < imme){
                RegFile[rt]=1;
            }
        ...
        else if (opcode==0x2c000000){ //sltiu
            uint32_t imme = CurrentInstruction & 0x0000ffff;
